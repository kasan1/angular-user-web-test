...
@Component({
  ...
  selector: 'app-okaps-dialog',
  templateUrl: './okaps-dialog.component.html',
  styleUrls: ['./okaps-dialog.component.scss'],
  animations: [fadeInOutTrigger],
})
export class OkapsDialogComponent implements OnInit, AfterViewInit {
